...
<img src="https://latex.codecogs.com/gif.latex?g1(\vec{x}):0,75-\prod_{i=1}^{n}&space;x_{i}&space;\leq&space;0" title="g1(\vec{x}):0,75-\prod_{i=1}^{n} x_{i} \leq 0" />

<img src="https://latex.codecogs.com/gif.latex?g2(\vec{x}):&space;\sum&space;_{i=1}^{n}x_{i}-7,5n\leq0" title="g2(\vec{x}): \sum _{i=1}^{n}x_{i}-7,5n\leq0" />
